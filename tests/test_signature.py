...
class SignAndVerifyTestCase(TestCase):
    def test_success(self):
        ...
        self.assertEqual(res.cert.subject.data, subject_dict)
    ...
    #     self.assertDictEqual(cert.alt_name.data, {'OGRNIP': '123456789012345'})
...
class GetSignerCertFromSignatureTestCase(TestCase):
    def test_success(self):
        ...
        subject_dict = cert.subject.data
        self.assertEqual(
            subject_dict,
            {
                'CN': 'pycryptoprosdk',
        ...
        self.assertEqual(cert.subject.data, subject_dict)
